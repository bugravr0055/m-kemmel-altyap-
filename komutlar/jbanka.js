...
.addField('Nasıl Para Kazanabilirim?:', 'Snax,gündelik olarak para verir.Bu değeri şirket açarak arttırabilirsiniz! şirket açmak için,**!şirket** kullanın.')
.addField('Şirket Ne işe yarar?:', 'Gündelik olarak kazandığınız parayı arttırır.')
.addField('Bot kurucusu ile nasıl iletişime geçerim?:', '[Destek Sunucumuza](https://discord.gg/hggzVGv) gelerek yapımcı ile iletişime geçebilirsin.')
