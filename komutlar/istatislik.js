...
module.exports.run = async(client, message, args) => {
  ...
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .setTitle(':bar_chart: Snax Bot :bar_chart:')
    ...
    .addField(`Discord.js sürümü:`, Discord.version, true)
      .addField(':spy: Yapımcım:', '<@629377827392716842> \n `Snax`', false)
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **16.10.2019**'de yapılmaya başlanmıştır", true)
    .setFooter('Snax Bot | Her Hakkı Saklıdır..', client.user.avatarURL)
    .setTimestamp()
